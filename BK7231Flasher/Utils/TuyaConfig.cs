...
namespace BK7231Flasher
{
    public class TuyaConfig
    {
        ...
        // --------------------------------------------------------------------
        // JSON-driven mapping structures (load once, used exclusively)
        // --------------------------------------------------------------------
        ...
        public string getKeysHumanReadable(OBKConfig tg = null)
        {
            ...
            foreach (var kv in parms)
            {
                ...
                {
                    mapping = mExact;
                    // Handle VALUEONLY or normal mapping
        ...
        // Compatibility stubs (other code expected these)
        public string getKeysHumanReadableEnhanced()
        {
            return getKeysHumanReadable();
        }
